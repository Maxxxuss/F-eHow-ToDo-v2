...
class DropDownCategorie extends Component {
  ...
  onNoteEdit = () => {
    const categorie = this.state.categorie.catName
      ? this.state.categorie.catName
      : this.props.activeNote.categorie.catName;
          ...
          {({
            ...
            <div>
              ...
              <div>
                <Input
                  placeholder={
                    this.props.acctiveNote ? this.state.categorie : "Categorie"
                  }
                  onChange={this.onContentChange}
                  {...getInputProps({
                    isOpen,
                    placeholder: activeNote
                      ? activeNote.categorie
                      : "Categorie",
...
export default connect(mapStateToProps, mapDispatchToProps)(DropDownCategorie);
