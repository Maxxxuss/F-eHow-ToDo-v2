...
//         <li
//           className={
//             this.state.activeNote.id === expense.id
//               ? "selected_noteListStylInt"
//               : "noteListStylInt"
//           }
//           key={expense.id}
...
//     const filteExp = this.props.expenses.filter(
//       (expense) => expense.categorie === categorie.catName
//     );
//     const catFilteExp = filteExp.filter(
//       (catExp) => catExp.noteStatus === "open"
//     );
...
//     this.setState({
//       filteredExp: this.props.expenses.filter(
...
//     if (activeCategorieCatName === "" && nStatus === "allOpen") {
//       this.setState({ noteListStatus: nStatus }, () => {
//         const catFilteExp = this.props.expenses.filter(
//           (catExp) =>
//             catExp.noteStatus === "open" && catExp.absDatesToFinish < "0.6"
//         );
//         this.setState({ filteredExp: catFilteExp });
...
//       this.setState({ noteListStatus: nStatus }, () => {
//         const filteExp = this.props.expenses.filter(
//           (expense) => expense.categorie === activeCategorieCatName
//         );
//         const catFilteExp = filteExp.filter(
//           (catExp) => catExp.noteStatus === nStatus
//         );
//         this.setState({ filteredExp: catFilteExp });
...
//     console.log(
//       "Status Change activeCategorieCatName:",
//       activeCategorieCatName
//     );
...
//   };
//   onDateChange = (e) => {
//     const datesToFinish = new Date(
//       new Date().getTime() + e.target.value * 24 * 60 * 60 * 1000
//     );
...
//     const noteDecscription = space.concat(
//       space,
//       timeStamp,
//       space,
//       notDes,
...
//       noteDecscription: space.concat(
//         space,
//         timeStamp,
//         space,
//         this.state.noteDecscription
//       ),
...
//       <Tab
//         key={categorie.sorting ? categorie.sorting : categorie.id}
...
//           <Box component="div" display="inline"></Box>
//         </Box>
...
//                       expense != null
//                         ? this.setActiveNote(expense)
//                         : this.clearShoweditRisks();
//                     }}
//                     options={filteredExp ? filteredExp : this.props.expenses}
//                     getOptionLabel={(filteredExp) =>
//                       filteredExp.description
//                         ? filteredExp.description +
//                           "  -  " +
//                           filteredExp.noteDecscription.substr(17, 235)
//                         : ""
//                     }
//                     style={{
//                       marginBottom: "10px",
...
//                 <Button onClick={this.clearShoweditRisks}> CLEAR</Button>

//                 <Button onClick={this.statusChange}>
//                   Set Status:{" "}
//                   {this.state.activeNote.noteStatus === "closed"
//                     ? "open"
//                     : "closed"}
//                 </Button>
