...
export default function SetRisk(props) {
  ...
  const propRiskAus = props.activeNote.riskAuswirkung
    ? props.activeNote.riskAuswirkung
    : "";
  const propsRiskWahr = props.activeNote.riskWahrscheinlichkeit
    ? props.activeNote.riskWahrscheinlichkeit
    : "";
  ...
  const handelAddRisk = () => {
    props.editNote(props.activeNote.id, {
